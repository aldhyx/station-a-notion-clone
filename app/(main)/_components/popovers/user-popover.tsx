      ...
      >
        <div className="w-80">
          <section className="border-b border-zinc-200 p-3">
            <span className="mb-3 block text-xs text-zinc-600">{email}</span>
          ...
          <section className="w-full bg-zinc-100">
            <SignOutDialog>
              <Button
                variant="ghost"
                className="h-9 w-full justify-start rounded-none rounded-b-sm px-3 text-xs font-normal text-zinc-600 "
              >
